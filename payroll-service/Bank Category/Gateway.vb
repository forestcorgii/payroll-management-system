...
Namespace BankCategory
    Public Class Gateway

        Public Shared Function CollectFromPreviousCutOff(databaseManager As Manager.Mysql, bankCategory As String, previousCutoffRange As Date()) As List(Of Model)
            Dim bankCategories As New List(Of Model)
            ...
            Using reader As MySqlDataReader = databaseManager.ExecuteDataReader(
                ...
                While reader.Read
                    bankCategories.Add(New Model(reader))
                End While
            End Using
        ...
        Public Shared Sub Save(databaseManager As Manager.Mysql, bankCategory As String, ee_id As String)
            Try
        ...
        Public Shared Function Collect(databaseManager As Manager.Mysql) As List(Of String)
