...
Namespace Controller
    Public Class Employee
        ...
        Public Shared Async Function SyncEmployeeFromHRMSAsync(databaseManager As Manager.Mysql, hrmsAPIManager As Manager.API.HRMS, ee_id As String, Optional employee As Model.Employee = Nothing) As Task(Of Model.Employee)
            Dim employeeFound As IInterface.IEmployee = Await hrmsAPIManager.GetEmployeeFromServer(ee_id)
            If employeeFound IsNot Nothing Then
                If employee IsNot Nothing Then
                    employee = UpdateEmployee(databaseManager, employeeFound, employee)
                End If
                Return employee
            Else
