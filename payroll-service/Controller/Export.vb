...
Namespace Controller
    ...
    Public Class Export
        ...
        Public Shared Sub ExportDataCHECK(ByRef payArr As List(Of Model.Payroll), ByVal filePath As String, ByVal fileName As String)
            ...
            Try
                ...
                Dim Recordsd7500UP As Model.Payroll() = (From res In payArr Where Double.Parse(res.Net_Pay) >= 7500 Select res).ToArray
                Dim Records7500DOWN As Model.Payroll() = (From res In payArr Where Double.Parse(res.Net_Pay) < 7500 Select res).ToArray
                Dim Records200DOWN As Model.Payroll() = (From res In payArr Where Double.Parse(res.Net_Pay) >= 200 Select res).ToArray
                Dim Records100KUP As Model.Payroll() = (From res In payArr Where Double.Parse(res.Net_Pay) >= 100000 Select res).ToArray
            ...
            End Try
        End Sub
        Public Shared Sub WriteSpecificReport(sheet As ISheet, payrollRecords As Model.Payroll())
