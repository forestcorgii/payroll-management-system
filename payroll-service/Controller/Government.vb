...
Namespace Controller
    ...
    Public Class Government
        ...
        Public Shared Function Compute(government As Model.Government) As Model.Government
        ...
        Public Shared Function Find(databaseManager As Manager.Mysql, payroll_name As String) As Model.Government
            Dim government As Model.Government = Nothing
            Using reader As MySqlDataReader = databaseManager.ExecuteDataReader(
                ...
                If reader.HasRows Then
                    reader.Read()
                    government = New Model.Government(reader)
                End If
            End Using

            Return government
        End Function
        Public Shared Sub Save(databaseManager As Manager.Mysql, government As Model.Government)
            Try
