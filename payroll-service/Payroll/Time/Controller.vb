...
Namespace Payroll
    ...
    Namespace Time
        ...
        Public Class Controller
            ...
            End Sub
            Public Shared Sub ProcessPayrollTime(databaseManager As utility_service.Manager.Mysql, payrollDate As Date, payrollTime As payroll_time_service.Model.PayrollTime)
                Try
