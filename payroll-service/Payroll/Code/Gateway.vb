...
Namespace Payroll
    ...
    Namespace Code
        Public Class Gateway
            ...
            Public Shared Function CollectFromPreviousCutOff(databaseManager As Manager.Mysql, payrollCode As String, previousCutoffRange As Date()) As List(Of Model)
                Dim payrollCodes As New List(Of Model)
                ...
                Using reader As MySqlDataReader = databaseManager.ExecuteDataReader(
                    ...
                    While reader.Read
                        payrollCodes.Add(New Model(reader))
                    End While
                End Using
            ...
            'Public Shared Function GetHistory(databaseManager As Manager.Mysql, ee_id As String) As Code.modelHistory
            '    Dim payrollCodeHistory As New Code.modelHistory
            '    Try
            ...
            '            While reader.Read
            '                payrollCodeHistory.History.Add(New Code.Model(reader))
            '            End While
            '        End Using
            '    Catch ex As Exception
            '        MessageBox.Show(ex.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error)
