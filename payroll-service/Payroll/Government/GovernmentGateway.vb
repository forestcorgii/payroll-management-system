...
Namespace Payroll
    ...
    Public Class GovernmentGateway
        ...
        Public Shared Function Compute(government As GovernmentModel) As GovernmentModel
            ...
            End If
            government.Pagibig_EE = -government.Pagibig_EE
        ...
        Public Shared Function Find(databaseManager As Manager.Mysql, payroll_name As String) As GovernmentModel
            Dim government As GovernmentModel = Nothing
            Using reader As MySqlDataReader = databaseManager.ExecuteDataReader(
                    String.Format("SELECT * FROM payroll_db.government where payroll_name='{0}' LIMIT 1;", payroll_name))
                If reader.HasRows Then
                    reader.Read()
                    government = New GovernmentModel(reader)
                End If
            End Using

            Return government
        End Function
        Public Shared Sub Save(databaseManager As Manager.Mysql, government As GovernmentModel)
            Try
